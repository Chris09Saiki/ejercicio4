class ComentariosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to comentarios_path, status: :see_other, notice: "Comentario eliminado." }
  ...
  private
    ...
    def comentario_params
      params.require(:comentario).permit(:contenido, :usuario_id, :articulo_id)
    end
end
